...
const agents = [
  ...
  ['agent-row-failing', 'agent-failing', 'Failing agent', 'error', '*/10 * * * *', ms(-10 * 60000)],
];
...
const runRows = [
  ['run-fresh-1', 'agent-fresh', -45_000, 0, 'success', 45_000, 'Fresh run completed normally.', null, { inputTokens: 1800, outputTokens: 600 }, 11],
  ...
  ['run-failing-1', 'agent-failing', -10 * 60_000, -9 * 60_000, 'failure', 60_000, 'Command exited with code 1.', 'Recent failing run 1 of 3.', { inputTokens: 320000, outputTokens: 85000 }, 240],
